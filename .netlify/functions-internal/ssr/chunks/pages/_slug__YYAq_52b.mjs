/* empty css                         */
import { A as AstroError, b as InvalidImageService, c as ExpectedImageOptions, E as ExpectedImage, d as createAstro, e as createComponent, f as ImageMissingAlt, r as renderTemplate, m as maybeRenderHead, g as addAttribute, s as spreadAttributes, h as renderComponent, i as renderHead, j as renderSlot, k as UnknownContentCollectionError, l as renderUniqueStylesheet, n as renderScriptElement, o as createHeadAndContent, u as unescapeHTML } from '../astro_pwjqXPXT.mjs';
import { i as isESMImportedImage, a as isLocalService, b as isRemoteImage, D as DEFAULT_HASH_PROPS, p as prependForwardSlash } from '../astro/assets-service_NcVb__a3.mjs';

async function getConfiguredImageService() {
  if (!globalThis?.astroAsset?.imageService) {
    const { default: service } = await import(
      // @ts-expect-error
      '../astro/assets-service_NcVb__a3.mjs'
    ).then(n => n.s).catch((e) => {
...
const renderEntryGlob = /* #__PURE__ */ Object.assign({"/src/content/posts/behind-the-scenes-with-our-artists.mdx": () => import('../behind-the-scenes-with-our-artists_CfWTmQQ6.mjs'),"/src/content/posts/collaboration-in-music-production.md": () => import('../collaboration-in-music-production_wAuxBd6x.mjs'),"/src/content/posts/creating-a-successful-music-brand.md": () => import('../creating-a-successful-music-brand_mB97wxFX.mjs'),"/src/content/posts/gear-is-insanely-expensive.md": () => import('../gear-is-insanely-expensive_22AfH2Lo.mjs'),"/src/content/posts/guitar-solos-are-still-awesome.md": () => import('../guitar-solos-are-still-awesome_ePc9deVB.mjs'),"/src/content/posts/live-music-is-crucial.md": () => import('../live-music-is-crucial_tMb824vU.mjs'),"/src/content/posts/making-a-home-studio.md": () => import('../making-a-home-studio_AsqtXbYs.mjs'),"/src/content/posts/the-art-of-music-production.md": () => import('../the-art-of-music-production_6DbWK-a3.mjs'),"/src/content/posts/the-importance-of-audio-quality.md": () => import('../the-importance-of-audio-quality_pOurm7IG.mjs'),"/src/content/posts/tune-your-snare-drum.md": () => import('../tune-your-snare-drum_SGyMqsOf.mjs')});
